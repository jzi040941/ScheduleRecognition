...
logs_dir= "zoo/model_zoo/fcn_tensorflow/logs/timetableseg"# "path to logs directory where trained model and information will be stored"
Image_Dir="zoo/data_zoo/fcn_timetableseg"# Test image folder
w=0.6# weight of overlay on image
Pred_Dir="output/Output_Prediction/fcn_timetableseg/" # Library where the output prediction will be written
