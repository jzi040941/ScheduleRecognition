...
Train_Image_Dir="Data_Zoo/table_croped/" # Images and labels for training
Train_Label_Dir="Data_Zoo/table_croped_Gt"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
