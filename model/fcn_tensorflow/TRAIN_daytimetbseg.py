...
#    The Label Maps should be saved as png image
# with same name as the corresponding image and png ending
# 3) Download pretrained vgg16 model and put in model_path 
# (should be done autmatically if you have internet connection)
...
Train_Image_Dir="Data_Zoo/table_croped_reshape/" # Images and labels for training
Train_Label_Dir="Data_Zoo/table_croped_Gt_resize_gray/"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
...
logs_dir= "logs/daytimetbseg/"# "path to logs directory where trained model and information will be stored"
